    ...
    <AnimatePresence>
      <motion.aside
        ...
        className={clsxm(
          ...
          'absolute right-2 top-24 z-20 min-w-max justify-evenly gap-x-6 rounded-md border-2 bg-slate-600 p-8 shadow-lg shadow-slate-600/40 dark:bg-slate-700  lg:top-20 lg:-right-6 lg:rounded-xl landscape:flex landscape:px-11'
        )}
      >
        <ThemeSwitch />
        <ColorSwitch />
