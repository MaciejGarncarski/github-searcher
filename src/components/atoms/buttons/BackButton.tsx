...
export const BackButton = () => {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.9 }}
      className='z-10 inline-flex max-w-max items-center gap-2 rounded-md bg-slate-600 px-4 py-2 text-3xl text-white shadow-lg shadow-slate-600/40 focus:outline-offset-4 dark:bg-slate-700 lg:col-span-3'
    >
      <BsArrowLeft />
      Back
    </motion.button>
